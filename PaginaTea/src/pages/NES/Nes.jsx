...
export default function Nes() {
    return(
        <section className='nes-conteiner'>
            ...
            <div className='cards-nes-conteiner'>
                <article className='card-nes'>
                    <div className='nunito-font number-card-nes number1'>1</div>
                ...
                <article className='card-nes'>
                    <div className='nunito-font number-card-nes number2'>2</div>
                ...
                <article className='card-nes'>
                    <div className='nunito-font number-card-nes number3'>3</div>
